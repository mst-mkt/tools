  ...
  return (
    <>
      ...
      <div className="it flex flex-col gap-y-8">
        ...
        <Textarea value={text} onChange={setText} placeholder="反復する文字を入力" />
        <div className="flex flex-col gap-y-2">
          <p className="text-sm">反復回数</p>
          <div className="flex items-center gap-x-2">
            <RangeInput value={repeat} onChange={setRepeat} min={1} max={100} />
            <NumberInput value={repeat} onChange={setRepeat} />
          </div>
        </div>
        <Textarea value={repeatedText} readOnly={true} placeholder="反復された文字列" />
