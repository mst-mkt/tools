...
export const Route = createFileRoute('/_layout/formatter/zig')({
...
const Zig = () => {
  ...
  return (
    <>
      <Head title="Zig Formatter" />
      <div className="flex flex-col gap-y-4">
        <h1 className="font-bold text-lg">Zig Formatter</h1>
        <Textarea value={code} onChange={setCode} placeholder="Enter Zig code..." />
        <div className="scrollbar-thin scrollbar-thumb-background-200 scrollbar-thumb-rounded-full scrollbar-track-transparent overflow-y-hidden overflow-x-scroll rounded-md border border-background-100 p-4 text-sm">
          <Code lang="zig" code={formattedCode} />
        </div>
